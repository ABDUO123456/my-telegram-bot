...
bot.start((ctx) => {
    ctx.reply('🌹 مرحباً بك في بوت أذكار المسلم الشامل\nاختر من القائمة بالأسفل:', mainKeyboard).catch(e => console.log("Blocked"));
});
...
async function sendMessages(ctx, list) {
    for (const msg of list) {
        try {
            ...
            console.log("Error sending message:", e.description);
            break; 
        }
    }
}
...
bot.launch().then(() => console.log("🚀 البوت يعمل الآن بجميع الأذكار بدون نقص!"));
